        ...
        <section className="container relative py-20 md:py-32 flex flex-col items-center text-center space-y-8">
          ...
          <div className="flex flex-col items-center pt-12 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500">
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-8">
              ...
              {/* Minecraft */}
              <div className="group flex flex-col items-center gap-2">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-[#62B47A]/20 border border-[#62B47A]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_-5px_rgba(98,180,122,0.5)] hover:bg-[#62B47A]/30">
                  <svg viewBox="0 0 24 24" className="w-7 h-7 md:w-8 md:h-8" fill="#62B47A">
                    <path d="M21.83 14.12c-.3-1.11-1.05-1.95-1.84-2.4.08-.23.14-.48.14-.74 0-1.26-1.02-2.28-2.28-2.28-.47 0-.91.14-1.28.4-.47-1.56-1.95-2.68-3.59-2.68-1.08 0-2.04.49-2.68 1.24-.77-.38-1.63-.5-2.49-.35-1.2.21-2.17 1.28-2.36 2.51-.14.9.08 1.77.55 2.47-.54.44-.9 1.08-.9 1.82 0 1.28 1.02 2.28 2.28 2.28.37 0 .73-.09 1.04-.24.31 1.13 1.31 1.96 2.5 2.13.85.12 1.67-.21 2.29-.83.38.09.78.14 1.19.14 1.26 0 2.28-1.02 2.28-2.28 0-.57-.22-1.11-.58-1.52.52-.38.92-.9 1.17-1.5.12.03.24.05.37.05 1.26 0 2.28-1.02 2.28-2.28 0-.42-.12-.81-.32-1.16zM17.36 9.7c.72 0 1.31.59 1.31 1.31 0 .72-.59 1.31-1.31 1.31-.72 0-1.31-.59-1.31-1.31 0-.72.59-1.31 1.31-1.31zM6.64 9.7c.72 0 1.31.59 1.31 1.31 0 .72-.59 1.31-1.31 1.31-.72 0-1.31-.59-1.31-1.31 0-.72.59-1.31 1.31-1.31zM4.55 6.28c.86 0 1.56.7 1.56 1.56 0 .57-.32 1.08-.79 1.34.03.17.07.34.11.5.19.88.75 1.63 1.53 2.07-.17.39-.27.82-.27 1.27 0 1.49 1.21 2.7 2.7 2.7.6 0 1.16-.2 1.61-.53.32.55.92.92 1.59.92.27 0 .53-.06.77-.16.36 1.02 1.35 1.76 2.49 1.76 1.08 0 2.01-.65 2.38-1.57.22.06.45.09.69.09.26 0 .51-.03.76-.08.47 1.03 1.53 1.75 2.71 1.75.03 0 .06 0 .09-.01-.03-.22-.05-.45-.05-.67 0-1.42 1.15-2.57 2.57-2.57.27 0 .53.04.78.12-.06-.45-.19-.88-.39-1.27.58-.48.97-1.21.97-2.02 0-.43-.11-.84-.3-1.21.32-.22.54-.59.54-1 0-.35-.14-.68-.36-.92.4-.31.67-.78.67-1.3 0-.42-.16-.81-.42-1.13-.07-.09-.15-.18-.24-.25-.12-.26-.2-.55-.2-.85 0-.42.11-.81.3-1.15z"/>
                  </svg>
                </div>
              ...
              {/* Roblox */}
              <div className="group flex flex-col items-center gap-2">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-[#E2231A]/20 border border-[#E2231A]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_-5px_rgba(226,35,26,0.5)] hover:bg-[#E2231A]/30">
                  <svg viewBox="0 0 24 24" className="w-7 h-7 md:w-8 md:h-8" fill="#E2231A">
